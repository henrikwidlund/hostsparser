...
namespace HostsParser
{
    internal static class Program
    {
        internal static async Task Main(string[] args)
        {
            ...
            using var httpResponseMessage = await httpClient.GetAsync("https://raw.githubusercontent.com/StevenBlack/hosts/master/alternates/fakenews-gambling-porn/hosts");
            httpResponseMessage.EnsureSuccessStatusCode();

            var lines = (await httpResponseMessage.Content.ReadAsStringAsync()).Split('\n');
        ...
        private static string Replace(ReadOnlySpan<char> item, int length)
